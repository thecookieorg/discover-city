class AddCachedVotesToRestaurants < ActiveRecord::Migration
  def self.up
    ...
    add_column :restaurants, :cached_weighted_score, :integer, :default => 0
    add_column :restaurants, :cached_weighted_total, :integer, :default => 0
    add_column :restaurants, :cached_weighted_average, :float, :default => 0.0
    ...
    add_index  :restaurants, :cached_weighted_score
    add_index  :restaurants, :cached_weighted_total
    add_index  :restaurants, :cached_weighted_average
  ...
  def self.down
    ...
    remove_column :restaurants, :cached_weighted_score
    remove_column :restaurants, :cached_weighted_total
    remove_column :restaurants, :cached_weighted_average
  end
end